...
subplot(2,2,2); plot(0:param.TTT-1,(ss1.Pi+[X_PF(:,2)]).^4-1,'linewidth',2,'color','k','linestyle','-');xlim([limit_x_start,limit_x_end])
subplot(2,2,3); plot(0:param.TTT-1,(ss1.R+[X_PF(:,6)]).^4-1,'linewidth',2,'color','k','linestyle','-');xlim([limit_x_start,limit_x_end])
